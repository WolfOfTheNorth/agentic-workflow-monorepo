# user-authentication - Task 1.2.1

Execute task 1.2.1 for the user-authentication specification.

## Task Description
Add authentication types to shared package
...
2. Execute task 1.2.1: "Add authentication types to shared package"
