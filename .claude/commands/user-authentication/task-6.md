...
Execute task 6 for the user-authentication specification.

## Task Description
x.1 Integrate linting, type-checking, and tests in CI
...
2. Execute task 6: "x.1 Integrate linting, type-checking, and tests in CI"
