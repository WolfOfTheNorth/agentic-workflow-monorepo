# user-authentication - Task 7.2.2

Execute task 7.2.2 for the user-authentication specification.
...
2. Execute task 7.2.2: "Implement backwards compatibility layer"
