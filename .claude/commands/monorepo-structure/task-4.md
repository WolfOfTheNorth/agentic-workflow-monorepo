# monorepo-structure - Task 4

Execute task 4 for the monorepo-structure specification.

## Task Description
Create packages/shared foundation
...
2. Execute task 4: "Create packages/shared foundation"
